 ...
 * This corresponds with EUnitSizeType to determine the damage done to a unit. See also IWeaponType,
 * DamageTypes, EUnitSizeType View on Liquipedia View on Starcraft Campendium (Official Website)
