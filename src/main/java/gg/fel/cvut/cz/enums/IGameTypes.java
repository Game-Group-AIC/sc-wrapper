...
public interface IGameTypes<T, V extends IGameTypes<T, V>> extends Serializable {
  ...
  Map<UpgradeTypeEnum, UnitTypeEnum> UPGRADE_RESEARCHED_AT = new ImmutableMap
      .Builder<UpgradeTypeEnum, UnitTypeEnum>()
      .put(UpgradeTypeEnum.TerranInfantryArmor, UnitTypeEnum.TerranEngineeringBay)
      .put(UpgradeTypeEnum.TerranVehiclePlating, UnitTypeEnum.TerranArmory)
      .put(UpgradeTypeEnum.TerranShipPlating, UnitTypeEnum.TerranArmory)
      .put(UpgradeTypeEnum.TerranInfantryWeapons, UnitTypeEnum.TerranEngineeringBay)
      .put(UpgradeTypeEnum.TerranVehicleWeapons, UnitTypeEnum.TerranArmory)
      .put(UpgradeTypeEnum.TerranShipWeapons, UnitTypeEnum.TerranArmory)
      .put(UpgradeTypeEnum.U238Shells, UnitTypeEnum.TerranAcademy)
      .put(UpgradeTypeEnum.IonThrusters, UnitTypeEnum.TerranMachineShop)
      .put(UpgradeTypeEnum.TitanReactor, UnitTypeEnum.TerranScienceFacility)
      .put(UpgradeTypeEnum.OcularImplants, UnitTypeEnum.TerranCovertOps)
      .put(UpgradeTypeEnum.MoebiusReactor, UnitTypeEnum.TerranCovertOps)
      .put(UpgradeTypeEnum.ApolloReactor, UnitTypeEnum.TerranControlTower)
      .put(UpgradeTypeEnum.ColossusReactor, UnitTypeEnum.TerranPhysicsLab)
      .put(UpgradeTypeEnum.CaduceusReactor, UnitTypeEnum.TerranAcademy)
      .put(UpgradeTypeEnum.CharonBoosters, UnitTypeEnum.TerranMachineShop)
      .put(UpgradeTypeEnum.ZergCarapace, UnitTypeEnum.ZergEvolutionChamber)
      .put(UpgradeTypeEnum.ZergFlyerCarapace, UnitTypeEnum.ZergSpire)
      .put(UpgradeTypeEnum.ZergMeleeAttacks, UnitTypeEnum.ZergEvolutionChamber)
      .put(UpgradeTypeEnum.ZergMissileAttacks, UnitTypeEnum.ZergEvolutionChamber)
      .put(UpgradeTypeEnum.ZergFlyerAttacks, UnitTypeEnum.ZergSpire)
      .put(UpgradeTypeEnum.VentralSacs, UnitTypeEnum.ZergLair)
      .put(UpgradeTypeEnum.Antennae, UnitTypeEnum.ZergLair)
      .put(UpgradeTypeEnum.PneumatizedCarapace, UnitTypeEnum.ZergLair)
      .put(UpgradeTypeEnum.MetabolicBoost, UnitTypeEnum.ZergSpawningPool)
      .put(UpgradeTypeEnum.AdrenalGlands, UnitTypeEnum.ZergSpawningPool)
      .put(UpgradeTypeEnum.MuscularAugments, UnitTypeEnum.ZergHydraliskDen)
      .put(UpgradeTypeEnum.GroovedSpines, UnitTypeEnum.ZergHydraliskDen)
      .put(UpgradeTypeEnum.GameteMeiosis, UnitTypeEnum.ZergQueensNest)
      .put(UpgradeTypeEnum.MetasynapticNode, UnitTypeEnum.ZergDefilerMound)
      .put(UpgradeTypeEnum.ChitinousPlating, UnitTypeEnum.ZergUltraliskCavern)
      .put(UpgradeTypeEnum.AnabolicSynthesis, UnitTypeEnum.ZergUltraliskCavern)
      .put(UpgradeTypeEnum.ProtossGroundArmor, UnitTypeEnum.ProtossForge)
      .put(UpgradeTypeEnum.ProtossAirArmor, UnitTypeEnum.ProtossCyberneticsCore)
      .put(UpgradeTypeEnum.ProtossGroundWeapons, UnitTypeEnum.ProtossForge)
      .put(UpgradeTypeEnum.ProtossAirWeapons, UnitTypeEnum.ProtossCyberneticsCore)
      .put(UpgradeTypeEnum.ProtossPlasmaShields, UnitTypeEnum.ProtossForge)
      .put(UpgradeTypeEnum.SingularityCharge, UnitTypeEnum.ProtossCyberneticsCore)
      .put(UpgradeTypeEnum.LegEnhancements, UnitTypeEnum.ProtossCitadelofAdun)
      .put(UpgradeTypeEnum.ScarabDamage, UnitTypeEnum.ProtossRoboticsSupportBay)
      .put(UpgradeTypeEnum.ReaverCapacity, UnitTypeEnum.ProtossRoboticsSupportBay)
      .put(UpgradeTypeEnum.GraviticDrive, UnitTypeEnum.ProtossRoboticsSupportBay)
      .put(UpgradeTypeEnum.SensorArray, UnitTypeEnum.ProtossObservatory)
      .put(UpgradeTypeEnum.GraviticBoosters, UnitTypeEnum.ProtossObservatory)
      .put(UpgradeTypeEnum.KhaydarinAmulet, UnitTypeEnum.ProtossTemplarArchives)
      .put(UpgradeTypeEnum.ApialSensors, UnitTypeEnum.ProtossFleetBeacon)
      .put(UpgradeTypeEnum.GraviticThrusters, UnitTypeEnum.ProtossFleetBeacon)
      .put(UpgradeTypeEnum.CarrierCapacity, UnitTypeEnum.ProtossFleetBeacon)
      .put(UpgradeTypeEnum.KhaydarinCore, UnitTypeEnum.ProtossArbiterTribunal)
      .put(UpgradeTypeEnum.ArgusJewel, UnitTypeEnum.ProtossFleetBeacon)
      .put(UpgradeTypeEnum.ArgusTalisman, UnitTypeEnum.ProtossTemplarArchives)
      .build();
