...
public interface IWeaponType {
    ...
    /**
     * Retrieves the unit type that is intended to use this weapon type. Note There is a rare case where some hero unit types use the same weapon. Returns The IUnitType that uses this weapon. See also IUnitType::groundWeapon, IUnitType::airWeapon
     */
    IUnitType whatUses();
    ...
    /**
     * Retrieves the upgrade type that increases this weapon's damage output. Returns The IUpgradeType used to upgrade this weapon's damage. See also damageBonus
     */
    ...
    /**
     * Checks if this weapon type can target air units. Returns true if this weapon type can target air units, and false otherwise. See also UnitInterface::isFlying, IUnitType::isFlyer
     */
    boolean targetsAir();

    /**
     * Checks if this weapon type can target ground units. Returns true if this weapon type can target ground units, and false otherwise. See also UnitInterface::isFlying, IUnitType::isFlyer
     */
    boolean targetsGround();

    /**
     * Checks if this weapon type can only target mechanical units. Returns true if this weapon type can only target mechanical units, and false otherwise. See also targetsOrgOrMech, IUnitType::isMechanical
     */
    boolean targetsMechanical();

    /**
     * Checks if this weapon type can only target organic units. Returns true if this weapon type can only target organic units, and false otherwise. See also targetsOrgOrMech, IUnitType::isOrganic
     */
    boolean targetsOrganic();

    /**
     * Checks if this weapon type cannot target structures. Returns true if this weapon type cannot target buildings, and false if it can. See also IUnitType::isBuilding
     */
    boolean targetsNonBuilding();

    /**
     * Checks if this weapon type cannot target robotic units. Returns true if this weapon type cannot target robotic units, and false if it can. See also IUnitType::isRobotic
     */
    ...
    /**
     * Checks if this weapon type can only target organic or mechanical units. Returns true if this weapon type can only target organic or mechanical units, and false otherwise. See also targetsOrganic, targetsMechanical, IUnitType::isOrganic, IUnitType::isMechanical
     */
    ...
    default double getDamageNormalized() {
