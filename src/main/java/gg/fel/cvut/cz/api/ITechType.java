...
public interface ITechType {
    ...
    /**
     * Retrieves the amount of energy needed to use this ITechType as an ability. Returns Energy cost of the ability. See also UnitInterface::getEnergy
     */
    int energyCost();

    /**
     * Retrieves the Weapon that is attached to this tech type. A technology's IWeaponType is used to indicate the range and behaviour of the ability when used by a IUnit. Returns IWeaponType containing information about the ability's behavior. Return values WeaponTypes::None If there is no corresponding IWeaponType.
     */
    IWeaponType getWeapon();
