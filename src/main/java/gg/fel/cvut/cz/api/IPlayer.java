...
public interface IPlayer {
     ...
     */
    boolean isEnemy(IPlayer player);
     ...
     */
    ITilePosition getStartLocation();
    ...
    int allUnitCount(IUnitType unit);
    ...
    int visibleUnitCount(IUnitType unit);
    ...
    int completedUnitCount(IUnitType unit);
    ...
    int incompleteUnitCount(IUnitType unit);
    ...
    int deadUnitCount(IUnitType unit);
    ...
    int killedUnitCount(IUnitType unit);
     ...
     */
    int getUpgradeLevel(IUpgradeType upgrade);
     ...
     */
    boolean hasResearched(ITechType tech);
     ...
     */
    boolean isResearching(ITechType tech);
     ...
     */
    boolean isUpgrading(IUpgradeType upgrade);
     ...
     */
    double topSpeed(IUnitType unit);
     ...
     */
    int weaponMaxRange(IWeaponType weapon);
     ...
     */
    int weaponDamageCooldown(IUnitType unit);
     ...
     */
    int getMaxUpgradeLevel(IUpgradeType upgrade);
     ...
     */
    boolean isResearchAvailable(ITechType tech);
     ...
     */
    boolean isUnitAvailable(IUnitType unit);
     ...
     */
    boolean hasUnitTypeRequirement(IUnitType unit);

    boolean hasUnitTypeRequirement(IUnitType unit, int amount);
